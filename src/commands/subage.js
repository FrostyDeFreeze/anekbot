...
module.exports = {
	...
	async execute(client, ctx, utils) {
		...
		const expiredSub = [
			...
			`Тоже ждешь подарочную от Анонима?`,
		...
		const giftedSub = [
			...
			`Твоё любимое число не 69? А то я других причин не вижу, почему тебе её подарили`
		]
